...
(function(){
	...
	listObserver.observe(document.getElementById('reader_pane'), {attributes: false, childList: true, characterData: false , subtree: false});
...
// 				}
	...
	articleObserver.observe(document.getElementById('three_way_contents'), {attributes: false, childList: true, characterData: false , subtree: false});
